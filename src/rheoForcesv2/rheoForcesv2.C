...
{
    defineTypeNameAndDebug(rheoForcesv2, 0);

    addToRunTimeSelectionTable(functionObject, rheoForcesv2, dictionary);
}
}
...
Foam::wordList Foam::functionObjects::rheoForcesv2::createFileNames
(
...
void Foam::functionObjects::rheoForcesv2::writeFileHeader(const label i)
{
...
void Foam::functionObjects::rheoForcesv2::initialise()
{
    if (initialised_)
    {
        return;
...
Foam::functionObjects::rheoForcesv2::devTau() const
{
...
Foam::tmp<Foam::volScalarField> Foam::functionObjects::rheoForcesv2::mu() const
{
    typedef incompressible::momentumTransportModel icoModel;
    typedef compressible::momentumTransportModel cmpModel;
    typedef phaseIncompressible::momentumTransportModel phaseIcoModel;
...
Foam::tmp<Foam::volScalarField> Foam::functionObjects::rheoForcesv2::rho() const
{
    if (rhoName_ == "rhoInf")
    {
...
Foam::scalar Foam::functionObjects::rheoForcesv2::rho(const volScalarField& p) const
{
...
Foam::tmp<Foam::volScalarField> Foam::functionObjects::rheoForcesv2::alpha() const
{
...
Foam::tmp<Foam::scalarField> Foam::functionObjects::rheoForcesv2::alpha
(
    const label patchi
) const
{
...
void Foam::functionObjects::rheoForcesv2::applyBins
(
...
void Foam::functionObjects::rheoForcesv2::writeForces()
{
...
void Foam::functionObjects::rheoForcesv2::writeBins()
{
    if (nBin_ == 1)
    {
        return;
...
Foam::functionObjects::rheoForcesv2::rheoForcesv2
(
    const word& name,
    const Time& runTime,
    const dictionary& dict
...
bool Foam::functionObjects::rheoForcesv2::read(const dictionary& dict)
{
...
void Foam::functionObjects::rheoForcesv2::calcForcesMoment()
{
    initialise();
...
Foam::vector Foam::functionObjects::rheoForcesv2::forceEff() const
{
    return sum(force_[0]) + sum(force_[1]) + sum(force_[2]) + sum(force_[3]);
}

Foam::vector Foam::functionObjects::rheoForcesv2::forcePress() const
{
    return sum(force_[0]);
}

Foam::vector Foam::functionObjects::rheoForcesv2::forceVisc() const
{
    return sum(force_[1]);
}

Foam::vector Foam::functionObjects::rheoForcesv2::forcePor() const
{
    return sum(force_[2]);
}

Foam::vector Foam::functionObjects::rheoForcesv2::forcePoly() const
{
    return sum(force_[3]);
}

Foam::vector Foam::functionObjects::rheoForcesv2::momentEff() const
{
    return sum(moment_[0]) + sum(moment_[1]) + sum(moment_[2]) + sum(moment_[3]);
}


bool Foam::functionObjects::rheoForcesv2::execute()
{
    return true;
}


bool Foam::functionObjects::rheoForcesv2::write()
{
    calcForcesMoment();
